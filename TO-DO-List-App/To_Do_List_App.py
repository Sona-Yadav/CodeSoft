...
class TodoListApp(Tk):
    ...
    def __init__(self):
        ...
        self.edit_img = PhotoImage(file="C://Sona//Company//CodSoft//edit.png")
        self.create_edit_button()
        self.clear_img = PhotoImage(file= "C://Sona//Company//CodSoft//clear.png")
        self.create_clear_button()
        self.remove_img = PhotoImage(file='C://Sona//Company//CodSoft//remove.png')
        self.create_delete_button()
        self.uncross_img = PhotoImage(file='C://Sona//Company//CodSoft//save.png')
        self.create_uncross_button()
        self.cross_img = PhotoImage(file='C://Sona//Company//CodSoft//cross.png')
        self.create_cross_button()
        # Functions
        self.listbox_load()

    # Designing----application's interface

    def create_app_heading(self):
        """
        top heading for the application
        """
        app_heading = Label(self, text = "TO-DO-List Application", font = ('poppins', 27, 'bold'), pady = 20, bg = "#e9ecf4")
        app_heading.pack(fill = X)

    def give_separation_line(self):
        """
        separation line after a desired frame or widget.
        """
